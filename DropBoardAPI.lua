local targetDate = os.time({year=2024, month=7, day=8, hour=16, min=0, sec=0})
...
workspace.DropBoard.Board.SurfaceGui.MessageLabel.Text = "Tix Shaggy"
workspace.DropBoard.Board.SurfaceGui.ImageLabel.Image = "rbxthumb://type=Asset&id=382881373&w=420&h=420"
workspace.DropBoard.Board.SurfaceGui.InfoLabel.Text = "Copies: 40, Price: 20,000"
