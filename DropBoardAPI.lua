local targetDate = os.time({year=2024, month=7, day=7, hour=16, min=0, sec=0})
...
workspace.DropBoard.Board.SurfaceGui.MessageLabel.Text = "Bluesteel Domino Crown"
workspace.DropBoard.Board.SurfaceGui.ImageLabel.Image = "rbxthumb://type=Asset&id=68258723&w=420&h=420"
workspace.DropBoard.Board.SurfaceGui.InfoLabel.Text = "Copies: 150, Price: 150"
